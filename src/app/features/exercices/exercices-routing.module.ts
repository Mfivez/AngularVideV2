...
const routes: Routes = [
  ...
  {path: "8", component: ServiceInjectionComponent},
  {path: "9", component: CorrectionFormulaireSebComponent},
  {path: "10", component: RouterGuardResolverComponent},
  {path: '10', loadChildren: () => import('./router-guard-resolver/router-guard-resolver.module').then(m => m.RouterGuardResolverModule) },
